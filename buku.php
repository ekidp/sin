...
<body>
  <div class="container">
    <button class="btn btn-primary" onclick="window.location='t_buku.php';" >Tambah</button>
    <div class="table-responsive">
      <table data-toggle="table" data-pagination="true">
        ...
        <tbody>
          ...
          session_start();
          $num = 0;
          $q = mysqli_query($conn, "SELECT * FROM master_bybuku ORDER BY tahun desc") or die (mysql_error($conn));
