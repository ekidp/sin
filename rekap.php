          ...
          while($a = mysqli_fetch_array($q)){
            ...
            <tr>
              ...
              <td>
                <?php if ($a['validasi']==0) { ?>
                <div class="btn-group">
                  <button class="btn btn-primary center-block" onclick="window.location='akses/v_spp.php?idspp=<?= $a['id_spp_ms']?>&nis=<?= $NIS?>';" >Validasi</button>
                </div>
              <?php } ?>
              </td>
            </tr>
          ...
          while($a = mysqli_fetch_array($q)){
            ...
            <tr>
              ...
              <td>
                <?php if ($a['validasi']==0) { ?>
                <div class="btn-group">
                  <button class="btn btn-primary center-block" onclick="window.location='akses/v_anjas.php?idanjas=<?= $a['id_anjas']?>&nis=<?= $NIS?>';" >Validasi</button>
                </div>
              <?php } ?>
              </td>
            </tr>
          ...
          while($a = mysqli_fetch_array($q)){
            ...
            <tr>
              ...
              <td>
                <?php if ($a['validasi']==0) { ?>
                <div class="btn-group">
                  <button class="btn btn-primary center-block" onclick="window.location='akses/v_keg.php?idkeg=<?= $a['id_keg']?>&nis=<?= $NIS?>';" >Validasi</button>
                </div>
              <?php } ?>
              </td>
            </tr>
          ...
          while($a = mysqli_fetch_array($q)){
            ...
            <tr>
              ...
              <td>
                <?php if ($a['validasi']==0) { ?>
                <div class="btn-group">
                  <button class="btn btn-primary center-block" onclick="window.location='akses/v_buku.php?idbuku=<?= $a['id_buku']?>&nis=<?= $NIS?>';" >Validasi</button>
                </div>
              <?php } ?>
              </td>
            </tr>
          ...
          while($a = mysqli_fetch_array($q)){
            ...
            <tr>
              ...
              <td>
                <?php if ($a['validasi']==0) { ?>
                <div class="btn-group">
                  <button class="btn btn-primary center-block" onclick="window.location='akses/v_ppdb.php?idppdb=<?= $a['id_ppdb']?>&nis=<?= $NIS?>';" >Validasi</button>
                </div>
              <?php } ?>
              </td>
            </tr>
